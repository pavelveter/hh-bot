...
- Для production не нужно публиковать `8271` в интернет: контейнер можно биндить только на `127.0.0.1:8271`, а входящий Telegram webhook принимать через `nginx` на `https://bender.pavelveter.com/hh-bot`.
